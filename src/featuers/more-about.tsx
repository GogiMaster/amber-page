...
const moreAboutList:MoreAboutListType[]=[
    {
        ...
        text: <div className="home">
            ...
            <p>Kako je na snazi trenutno pravilo koje se odnosi na sve mlađe od 2005. godine, nemamo određeno dopušteno godište za rođene prije 2005. godine,
            mada smo zasigurni da starija demografija <span>GEN Z-a</span> može uči u družinu. A po neslužbenim podatcima sa Googleta najsatriji <span>GEN Z</span>
    ...
    },
    {
        ...
        text: <div className="home">
            ...
            A to znači da bacamo nepotrebne šale, komentare, osuđivanja itd. i to sve u šaljivom kontextu i nema ljutnje, jer tko se naljuti is <span> PUSSY</span>.
            Ali to ne znači da kad netko ima neku manu kojuon nije spreman shvatiti kroz šalu, da ga se ide "podjebavat", nego se u tom trenutku jedva nekak prešuti i sve bude u redu.</p>
